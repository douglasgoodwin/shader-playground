  ...
  build: {
    rollupOptions: {
      input: {
        ...
        pingpong: resolve(__dirname, 'pingpong/index.html'),
        'pingpong-lissajous': resolve(__dirname, 'pingpong/lissajous/index.html'),
        'pingpong-kaleidoscope': resolve(__dirname, 'pingpong/kaleidoscope/index.html'),
        'pingpong-whitney': resolve(__dirname, 'pingpong/whitney/index.html'),
        'pingpong-droste': resolve(__dirname, 'pingpong/droste/index.html'),
        ...
        pollen: resolve(__dirname, 'pollen/index.html'),
        ...
        'artists-emshwiller': resolve(__dirname, 'artists/ed-emshwiller/index.html'),
        'artists-beckett': resolve(__dirname, 'artists/adam-beckett/index.html'),
        'artists-priestley': resolve(__dirname, 'artists/joanna-priestley/index.html'),
        'artists-engel': resolve(__dirname, 'artists/jules-engel/index.html'),
        'artists-oneill': resolve(__dirname, 'artists/pat-oneill/index.html'),
        'artists-lasseter': resolve(__dirname, 'artists/john-lasseter/index.html'),
      },
    },
  },
})
