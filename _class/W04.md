...
Create a short visual-music piece by drawing constraints from chance: a real song (from the top 10 in your birth year) and one of thirteen shader-based techniques. The goal is to treat the music as a found object and technique as your primary constraint.
...
- **Mandalas** — Radial, kaleidoscopic structures that evolve like computational cinema.
...
- **Audio-reactive** — Spectrum data controlling raymarched shapes, colors, and fog.
